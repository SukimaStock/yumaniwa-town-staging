(function() {
  ...
  window.TOWN_SCENE_MAPS = {
    station_plaza: {
      ...
      blockedPoints: [],
      areaZones: [{ id: 'station_plaza', title: '駅前広場', subtitle: '駅と広場がひとつになった中心地', area: rect(0, 0, 24, 24) }],
      triggers: [
        { id: 'station_notice', label: '駅の案内', actionLabel: '読む', type: 'inspect', text: '湯間庭駅前広場。\n\n左に灯串横丁、右に湯窓通り、上に温泉方面、下にレジャーセンターがあります。', area: rect(10, 19, 4, 1), tapPadding: 1 },
      ...
      groundRects: [
        ...
        { x: 8, y: 16, w: 8, h: 5, color: '#e6d2a8' }
      ],
      decor: [
        deco(0, 5, 5, 12, '#735944', '#2d241b', '掲示板'),
        deco(19, 5, 5, 12, '#72806a', '#2d241b', '湯窓通り'),
        deco(8, 0, 8, 3, '#8a7d6a', '#2d241b', '温泉'),
        deco(8, 21, 8, 3, '#6d746b', '#2d241b', 'レジャー'),
        deco(8, 16, 8, 4, '#8c7b64', '#2d241b', '駅'),
        deco(5, 16, 2, 2, '#8c7b64', '#2d241b', ''),
        deco(17, 16, 2, 2, '#8c7b64', '#2d241b', '')
      ]
    },
    ...
    leisure_center_map: {
      ...
      passableRects: [rect(9, 0, 6, 24), rect(4, 5, 16, 14), rect(0, 9, 24, 6)],
      ...
      groundRects: [
        ...
        { x: 4, y: 5, w: 16, h: 14, color: '#5e594f' },
        { x: 9, y: 0, w: 6, h: 24, color: '#7a756a' }
      ],
      decor: [
